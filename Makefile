# This Makefile is for the autoipv6ptr extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[autoipv6ptr]
#     EXE_FILES => [q[script/autoipv6ptr]]
#     NAME => q[autoipv6ptr]
#     NO_META => q[1]
...
DISTNAME = autoipv6ptr
DISTVNAME = autoipv6ptr-0.01
...
EXE_FILES = script/autoipv6ptr

pure_all :: $(INST_SCRIPT)/autoipv6ptr
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/autoipv6ptr 

$(INST_SCRIPT)/autoipv6ptr : script/autoipv6ptr $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/autoipv6ptr
	$(CP) script/autoipv6ptr $(INST_SCRIPT)/autoipv6ptr
	$(FIXIN) $(INST_SCRIPT)/autoipv6ptr
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/autoipv6ptr
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="autoipv6ptr" VERSION="0.01">' > autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.32" />' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> autoipv6ptr.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> autoipv6ptr.ppd
